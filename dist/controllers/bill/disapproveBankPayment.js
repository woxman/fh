...
const disapproveBankPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const handle = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return yield bill_service_1.default.disapproveBankPayment(orderId, disapprovalMessage);
    });
    const extractOutput = (outputs) => outputs;
    return (0, helper_1.handleRequest)({ req, res, validationSchema, handle, extractOutput });
});
exports.default = disapproveBankPayment;
