...
const getFactoriesBySubcategoryId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const handle = () => __awaiter(void 0, void 0, void 0, function* () {
        const { subcategoryId } = req.params;
        return yield factory_service_1.default.getFactoriesBySubcategoryId(subcategoryId);
    });
    const extractOutput = (outputs) => outputs;
    return (0, helper_1.handleRequest)({ req, res, handle, extractOutput });
});
exports.default = getFactoriesBySubcategoryId;
