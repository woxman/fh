...
const getOrderByTrackingCode = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const handle = () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const userId = (_a = res.locals.user) === null || _a === void 0 ? void 0 : _a._id;
        const { trackingCode } = req.params;
        if (userId) {
            return yield order_service_1.default.getOrderByTrackingCode(trackingCode, userId);
        }
        else {
            return yield order_service_1.default.getOrderByTrackingCode(trackingCode);
        }
    });
    const extractOutput = (outputs) => outputs;
    return (0, helper_1.handleRequest)({ req, res, handle, extractOutput });
});
exports.default = getOrderByTrackingCode;
