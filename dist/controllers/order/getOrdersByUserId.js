...
const getOrdersByUserId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const handle = () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const userId = ((_a = res.locals.user) === null || _a === void 0 ? void 0 : _a._id) || req.params.userId;
