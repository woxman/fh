...
const addOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const handle = () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const { products, phoneNumber, address, fullNameOfReceiverParty, accountNumber, fullNameOfAccountOwner, shabaNumber } = req.body;
        ...
        return yield order_service_1.default.addOrder(userId, newOrder);
    });
