...
const category_service_1 = __importDefault(require("../../db/models/category/category.service"));
const editCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const handle = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return yield category_service_1.default.editCategory(categoryId, updates);
    });
