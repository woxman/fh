...
exports.websitePageRouter = exports.panelPageRouter = void 0;
const express_1 = require("express");
const auth_1 = __importDefault(require("../../middlewares/auth"));
const addPage_1 = __importDefault(require("./addPage"));
const getPage_1 = __importDefault(require("./getPage"));
const getPages_1 = __importDefault(require("./getPages"));
const getPagesByCategory_1 = __importDefault(require("./getPagesByCategory"));
const getPagesByTag_1 = __importDefault(require("./getPagesByTag"));
const editPage_1 = __importDefault(require("./editPage"));
const deletePages_1 = __importDefault(require("./deletePages"));
const getTags_1 = __importDefault(require("./getTags"));
const getCategorys_1 = __importDefault(require("./getCategorys"));
exports.panelPageRouter = (0, express_1.Router)();
exports.websitePageRouter = (0, express_1.Router)();
/**
 * @swagger
 * components:
 *  securitySchemes:
 ...
 *                   type: string
 */
exports.panelPageRouter.post('/', (0, auth_1.default)('admin'), addPage_1.default);
/**
 * @swagger
 * /panel/page/{pageId}:
 *   get:
 ...
 *                   type: string
 */
exports.panelPageRouter.get('/:pageId', (0, auth_1.default)('admin'), getPage_1.default);
/**
 * @swagger
 * /panel/page:
 *   get:
 ...
 *                   type: string
 */
exports.panelPageRouter.get('/', (0, auth_1.default)('admin'), getPages_1.default);
/**
 * @swagger
 * /panel/page/{pageId}:
 *   patch:
 ...
 *                   type: string
 */
exports.panelPageRouter.patch('/:pageId', (0, auth_1.default)('admin'), editPage_1.default);
/**
 * @swagger
 * /panel/page/delete:
 *   post:
 ...
 *                   type: string
 */
exports.panelPageRouter.post('/delete', (0, auth_1.default)('admin'), deletePages_1.default);
/**
 * @swagger
 * /panel/page/tags/all:
 *   get:
 ...
 *                   type: string
 */
exports.panelPageRouter.get('/tags/all', (0, auth_1.default)('admin'), getTags_1.default);
/**
 * @swagger
 ...
 *                   type: string
 */
exports.panelPageRouter.get('/tags/all', (0, auth_1.default)('admin'), getCategorys_1.default);
//----------------------------------------------------
/**
 * @swagger
 * /website/page/{pageId}:
 ...
 *                   type: string
 */
exports.websitePageRouter.get('/:pageId', getPage_1.default);
/**
 * @swagger
 * /website/page:
 *   get:
 ...
 *                   type: string
 */
exports.websitePageRouter.get('/', getPages_1.default);
/**
 * @swagger
 ...
 *                   type: string
 */
exports.websitePageRouter.get('/category/:categoryValue', getPagesByCategory_1.default);
/**
 * @swagger
 ...
 *                   type: string
 */
exports.websitePageRouter.get('/tag/:tagValue', getPagesByTag_1.default);
/**
 * @swagger
 ...
 *                   type: string
 */
exports.websitePageRouter.get('/tags/all', getTags_1.default);
