...
exports.panelReportRouter = void 0;
const express_1 = require("express");
const auth_1 = __importDefault(require("../../middlewares/auth"));
const getReports_1 = __importDefault(require("./getReports"));
exports.panelReportRouter = (0, express_1.Router)();
/**
 * @swagger
 * /panel/report:
 *   get:
 ...
 *                   type: string
 */
exports.panelReportRouter.get('/', (0, auth_1.default)('admin'), getReports_1.default);
