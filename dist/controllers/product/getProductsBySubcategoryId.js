...
const getProductsBySubcategoryId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const handle = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return yield product_service_1.default.getProductsBySubcategoryId(subcategoryId, options);
    });
    const extractOutput = (outputs) => outputs;
    return (0, helper_1.handleRequest)({ req, res, queryValidationSchema, handle, extractOutput });
});
exports.default = getProductsBySubcategoryId;
