...
const editQuestionAndAnswer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const handle = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const questionAndAnswerUpdates = {};
        ...
        return yield siteInfoContactUs_service_1.default.editQuestionAndAnswer(questionAndAnswerId, questionAndAnswerUpdates);
    });
    const extractOutput = (outputs) => outputs;
    return (0, helper_1.handleRequest)({ req, res, validationSchema, handle, extractOutput });
});
exports.default = editQuestionAndAnswer;
