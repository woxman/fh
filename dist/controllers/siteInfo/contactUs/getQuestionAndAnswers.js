...
const getQuestionAndAnswers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const queryValidationSchema = yup.object().shape({
        limit: yup.string(),
        skip: yup.string(),
        sortBy: yup.string().oneOf(["question", "createdAt"]),
