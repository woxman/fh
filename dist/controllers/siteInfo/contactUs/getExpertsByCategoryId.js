...
const siteInfoContactUs_service_1 = __importDefault(require("../../../db/models/siteInfo/siteInfoContactUs.service"));
const getExpertsByCategoryId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const handle = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return yield siteInfoContactUs_service_1.default.getExpertsByCategoryId(categoryId, options);
    });
    const extractOutput = (outputs) => outputs;
    return (0, helper_1.handleRequest)({ req, res, handle, extractOutput, queryValidationSchema });
});
exports.default = getExpertsByCategoryId;
