...
exports.websiteAboutUsRouter = exports.panelAboutUsRouter = void 0;
...
const editProject_1 = __importDefault(require("./editProject"));
const deleteProjects_1 = __importDefault(require("./deleteProjects"));
exports.panelAboutUsRouter = (0, express_1.Router)();
exports.websiteAboutUsRouter = (0, express_1.Router)();
/**
 * @swagger
 * tags:
 * - name: About us | Panel
 ...
 *                   type: string
 */
exports.panelAboutUsRouter.put('/page-content', (0, auth_1.default)('admin'), updatePageContent_1.default);
/**
 * @swagger
 * /panel/site-info/about-us/page-content:
 *   get:
 ...
 *                   type: string
 */
exports.panelAboutUsRouter.get('/page-content', (0, auth_1.default)('admin'), getPageContent_1.default);
/**
 * @swagger
 ...
 *                   type: string
 */
exports.panelAboutUsRouter.post('/project', (0, auth_1.default)('admin'), addProject_1.default);
/**
 * @swagger
 ...
 *                   type: string
 */
exports.panelAboutUsRouter.get('/project/:projectId', (0, auth_1.default)('admin'), getProject_1.default);
/**
 * @swagger
 * /panel/site-info/about-us/project:
 *   get:
 ...
 *                   type: string
 */
exports.panelAboutUsRouter.get('/project', (0, auth_1.default)('admin'), getProjects_1.default);
/**
 * @swagger
 * /panel/site-info/about-us/project/{projectId}:
 *   patch:
 ...
 *                   type: string
 */
exports.panelAboutUsRouter.patch('/project/:projectId', (0, auth_1.default)('admin'), editProject_1.default);
/**
 * @swagger
 ...
 *                   type: string
 */
exports.panelAboutUsRouter.post('/project/delete', (0, auth_1.default)('admin'), deleteProjects_1.default);
//---------------------------------------------------------------------------
/**
 * @swagger
 ...
 *                   type: string
 */
exports.websiteAboutUsRouter.get('/page-content', getPageContent_1.default);
/**
 * @swagger
 ...
 *                   type: string
 */
exports.websiteAboutUsRouter.get('/project/:projectId', getProject_1.default);
/**
 * @swagger
 ...
 *                   type: string
 */
exports.websiteAboutUsRouter.get('/project', getProjects_1.default);
