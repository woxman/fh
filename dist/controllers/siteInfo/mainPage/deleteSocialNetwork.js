...
const deleteSocialNetwork = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const handle = () => __awaiter(void 0, void 0, void 0, function* () {
        const { socialNetworkId } = req.params;
        return yield siteInfoMainPage_service_1.default.deleteSocialNetwork(socialNetworkId);
    });
    return (0, helper_1.handleRequest)({ req, res, handle });
});
exports.default = deleteSocialNetwork;
