...
const deleteOrderStep = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const handle = () => __awaiter(void 0, void 0, void 0, function* () {
        const { orderStepId } = req.params;
        return yield siteInfoMainPage_service_1.default.deleteOrderStep(orderStepId);
    });
    return (0, helper_1.handleRequest)({ req, res, handle });
});
exports.default = deleteOrderStep;
